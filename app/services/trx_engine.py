...
TRX_INDEX_VIEW: typing.Dict[str, dict] = {
    ...
    "EMPLOYEE_ADVANCE": {
        "index_path": "/finance/employee-advance-payment",
        "doc_num_field": "employeeAdvancePaymentNum",
        "doc_date_field": "employeeAdvancePaymentDate",
        "status_field": "statusName",
        "date_filter": ("dateFrom", "dateTo"),
        "view": True,
        "identity_fields": ["employeeAdvancePaymentNum"],
    },
    "BUDGET_DETAIL": {
    ...
    "PURCHASE_INVOICE": {
        "index_path": "/purchase/purchase-invoice",
    ...
    "PURCHASE_RETURN": {
        "index_path": "/purchase/purchase-return",
    ...
    "BILL_OF_MATERIAL": {
        "index_path": "/production/bill-of-material",
        "doc_num_field": "billOfMaterialNum",
        "doc_date_field": "billOfMaterialDate",
        "status_field": "statusName",
        "date_filter": ("dateFrom", "dateTo"),
        "view": True,
        "identity_fields": ["billOfMaterialNum"],
    },
    "ADVANCE_RECAP": {
